...
width = cqvar(100.0, "Width of the block")
thickness = cqvar(10.0, "Thickness of the block")
center_hole_dia = cqvar(22.0, "Diameter of center hole in block")
cbore_hole_diameter = cqvar(2.4, "Bolt shank/threads clearance hole diameter")
cbore_inset = cqvar(12.0, "How far from the edge the cbored holes are set")
cbore_diameter = cqvar(4.4, "Bolt head pocket hole diameter")
cbore_depth = cqvar(2.1, "Bolt head pocket hole depth")
